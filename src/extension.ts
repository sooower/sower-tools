...
let pluginCtx: ExtensionContext;
let pluginName: string;

let workspaceConfig: WorkspaceConfiguration;
let userConfig: WorkspaceConfiguration;
let enableOverwriteFile: boolean;
let specialWordsMap: Map<string, string>;
...
export async function activate(context: ExtensionContext) {
    try {
        ...
        /* Register generate model command */
...
function getSettingItem(name: string): unknown {
